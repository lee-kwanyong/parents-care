...
const opsMenus = [
  {
    href: '/ops/today',
    title: '통합 오늘의 안심판',
    desc: '긴급, 확인 필요, 가족 할 일, 비용승인, 매니저 현장을 하나로 봅니다.'
  },
  {
    href: '/ops/cases',
    title: '통합 케어 케이스',
    desc: '걱정 접수, 매니저, 식사, 서류, 비용승인, 리포트를 하나로 묶습니다.'
  },
  {
    href: '/ops/costs',
    title: '추가비용 사전승인',
    desc: '택시비, 서류 발급비, 식사 배송비, 추가 동행시간을 승인 후 진행합니다.'
  },
  {
    href: '/ops/intake-inbox',
    title: '사진·카톡 접수함',
    desc: '예약 문자, 약 봉투, 영수증, 카톡 캡처를 케어 요청으로 변환합니다.'
  },
  {
    href: '/ops/manager-field',
    title: '매니저 현장 운영',
    desc: '현장 배정, 체크리스트, 케어패스포트, 리포트 초안을 관리합니다.'
  },
  {
    href: '/ops/contact-center',
    title: '연락센터',
    desc: '사전 안심전화, 30초 요약, 케어플랜 설명 연락을 관리합니다.'
  },
  {
    href: '/ops/social-care',
    title: '사회공헌 운영',
    desc: '공공지원, 후원 쿠폰, 식사 지원, 무료 안부 확인을 관리합니다.'
  },
  {
    href: '/ops/meals',
    title: '안심밥상 운영',
