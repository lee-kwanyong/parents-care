...
export default function ChildRoutinesPage() {
  return (
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-lg leading-8 text-[#63807C]">
              반복되는 진료와 다음 예약 후보를 확인합니다.
            </p>
          </div>

          <div className="flex gap-3">
            <Link href="/care-routines" className="rounded-2xl bg-[#8CCFC3] px-5 py-4 font-black text-[#2E504D]">
              정기 케어 등록
            </Link>
