      ...
      <section className="mx-auto max-w-3xl space-y-5">
        <section className="rounded-[2.5rem] bg-white p-6 shadow-[0_18px_52px_rgba(49,151,136,0.08)] ring-1 ring-[#D6EDE7] sm:p-8">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href="/subscription" className="rounded-2xl bg-[#247A71] px-5 py-4 text-sm font-black text-white">
              구독 관리
            </Link>
            <Link href="/child/weekly-report" className="rounded-2xl bg-white px-5 py-4 text-sm font-black text-[#17443F] ring-1 ring-[#D6EDE7]">
              주간 리포트
            </Link>
          </div>
        </section>
