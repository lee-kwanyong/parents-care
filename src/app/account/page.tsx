    ...
    <AppShell title="내 계정과 가족 공간" subtitle="부모님 걱정 접수, 케어팩, 사회공헌 연결이 이 가족 공간에 저장됩니다.">
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          ...
          <p className="rounded-2xl bg-slate-100 p-4 text-sm text-slate-600">사용자 ID: {user.id}</p>
        ...
        <Card>
          ...
          <Link href="/onboarding" className="mt-6 inline-block rounded-2xl bg-care-600 px-5 py-3 font-black text-white">가족 공간 설정</Link>
        </Card>
      </div>
    </AppShell>
  )
