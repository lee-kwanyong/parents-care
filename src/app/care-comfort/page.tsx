    ...
    <main className="min-h-screen bg-slate-50 px-5 py-8 text-slate-900">
      <section className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/ops/contact-center" className="rounded-2xl bg-slate-900 px-5 py-4 font-black text-white">
            운영실 연락센터
          </Link>
          <Link href="/child/summaries" className="rounded-2xl bg-emerald-600 px-5 py-4 font-black text-white">
            자녀 요약 보기
          </Link>
        </div>
