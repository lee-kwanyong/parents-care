      ...
      <section className="mt-8 rounded-[2rem] bg-slate-950 p-6 text-white">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          <div className="rounded-2xl bg-white/10 p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-200">요양보호사, 사회복지사, 간호 관련 자격, 병원동행 교육 수료, CPR 여부를 확인합니다.</p>
          </div>
          <div className="rounded-2xl bg-white/10 p-4">
            <div className="font-black">2. 현장 역량 확인</div>
            <p className="mt-2 text-sm leading-6 text-slate-200">지도앱, 택시앱, 키오스크, 보호자 질문 전달, 리포트 작성 능력을 봅니다.</p>
          </div>
          <div className="rounded-2xl bg-white/10 p-4">
            <div className="font-black">3. 차량 정책 분리</div>
            <p className="mt-2 text-sm leading-6 text-slate-200">차량 보유 여부는 표시하되 직접 유상운송은 기본 서비스와 분리합니다.</p>
          </div>
        </div>
      </section>
    </AppFrame>
