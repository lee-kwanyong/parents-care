...
const topLinks = [
  ...
  { href: '/child/daily-care', label: '보호자앱' }
]
...
const menuLinks = [
  ...
  { href: '/pricing', label: '금액', desc: '비용 안내' },
  { href: '/trust', label: '신뢰기준', desc: '검증·운영 기준' },
  { href: '/ops', label: '운영실', desc: '접수·매칭 관리' },
  { href: '/install', label: '홈추가', desc: '앱처럼 사용하기' }
]
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className="rounded-full bg-[#193B38] px-4 py-2 text-sm font-black text-white shadow-[0_8px_20px_rgba(25,59,56,0.16)] transition hover:bg-[#24423F]"
              aria-expanded={open}
              aria-label="메뉴 열기"
            >
              {open ? '닫기' : '메뉴'}
