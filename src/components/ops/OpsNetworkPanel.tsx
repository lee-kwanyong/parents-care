...
function statusClass(status?: string) {
  if (status === 'available' || status === 'verified') return 'bg-[#EFFFF9] text-[#116D5F] ring-[#CDEFE5]'
  if (status === 'paused' || status === 'blocked') return 'bg-[#FFF1F1] text-[#8A2525] ring-[#F3BBBB]'
        ...
        <section className="rounded-[2rem] bg-white p-5 shadow-sm ring-1 ring-[#D8EEE8] sm:p-6">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2 lg:grid-cols-3">
            {availableProviders.length === 0 ? (
              <div className="rounded-2xl bg-[#FFF1F1] p-5 text-sm font-black leading-7 text-[#8A2525] ring-1 ring-[#F3BBBB]">
    ...
    <article className="rounded-2xl bg-[#F8FCFB] p-4 ring-1 ring-[#D8EEE8]">
      ...
      <div className="mt-4 grid gap-2">
        <button
          ...
          disabled={loading}
          className="rounded-xl bg-white px-4 py-3 text-sm font-black text-[#173B36] ring-1 ring-[#D8EEE8] disabled:opacity-50"
        >
