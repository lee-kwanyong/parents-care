...
create index if not exists idx_care_providers_phone on public.care_providers(phone);
create index if not exists idx_care_providers_type_area on public.care_providers(provider_type, service_area);
...
create index if not exists idx_care_response_requests_status on public.care_response_requests(status, risk_level, created_at desc);
create index if not exists idx_care_response_requests_family on public.care_response_requests(family_code, status);
...
create index if not exists idx_care_response_matches_request on public.care_response_matches(request_id, match_status);
create index if not exists idx_care_response_matches_provider on public.care_response_matches(provider_id, match_status);
...
create index if not exists idx_notification_outbox_source on public.notification_outbox(source_key);
