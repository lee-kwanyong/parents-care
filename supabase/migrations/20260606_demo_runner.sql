...
create table if not exists public.gov_demo_runs (
  id uuid primary key default gen_random_uuid(),
  scenario_key text default 'urgent_full',
  scenario_label text,
  demo_phone text,
...
alter table public.gov_demo_runs add column if not exists scenario_key text default 'urgent_full';
alter table public.gov_demo_runs add column if not exists scenario_label text;
alter table public.gov_demo_runs add column if not exists demo_phone text;
alter table public.gov_demo_runs add column if not exists status text default 'created';
alter table public.gov_demo_runs add column if not exists family_code text;
alter table public.gov_demo_runs add column if not exists household_id uuid;
alter table public.gov_demo_runs add column if not exists request_ids jsonb default '[]'::jsonb;
alter table public.gov_demo_runs add column if not exists provider_ids jsonb default '[]'::jsonb;
alter table public.gov_demo_runs add column if not exists outbox_ids jsonb default '[]'::jsonb;
alter table public.gov_demo_runs add column if not exists summary text;
alter table public.gov_demo_runs add column if not exists payload jsonb default '{}'::jsonb;
alter table public.gov_demo_runs add column if not exists created_by text default '운영실';
alter table public.gov_demo_runs add column if not exists created_at timestamptz default now();
alter table public.gov_demo_runs add column if not exists completed_at timestamptz;
alter table public.gov_demo_runs add column if not exists cleaned_at timestamptz;

create index if not exists idx_gov_demo_runs_created
  on public.gov_demo_runs(created_at desc);

create index if not exists idx_gov_demo_runs_status
  on public.gov_demo_runs(status, created_at desc);
...
grant select, insert, update, delete on public.gov_demo_runs to anon, authenticated;
...
alter table public.gov_demo_runs enable row level security;
