...
create index if not exists idx_care_response_requests_timeline
  on public.care_response_requests(status, risk_level, created_at desc);

create index if not exists idx_care_response_requests_timeline_family
  on public.care_response_requests(family_code, created_at desc);
...
create index if not exists idx_care_response_matches_timeline
  on public.care_response_matches(request_id, created_at desc);
...
create index if not exists idx_notification_outbox_timeline_family
  on public.notification_outbox(family_code, created_at desc);

create index if not exists idx_notification_outbox_timeline_source
...
create index if not exists idx_care_response_updates_timeline
...
create index if not exists idx_ops_autopilot_logs_timeline
...
create index if not exists idx_ops_contact_attempts_timeline
...
create index if not exists idx_ops_incident_assignments_timeline
  on public.ops_incident_assignments(request_id, created_at desc);
